...
CommandScheduler.getInstance().schedule(new InstantCommand(()-> m_intake.agarrar(1)));
            ...
            CommandScheduler.getInstance().schedule(new InstantCommand(()-> m_intake.agarrar(0)));
            CommandScheduler.getInstance().schedule(new InstantCommand(()-> m_arm.setArmPosition(-180)));
        ...
        if (gamepad.getTrigger(GamepadKeys.Trigger.RIGHT_TRIGGER) > .5) {
            CommandScheduler.getInstance().schedule(new InstantCommand(()-> m_intake.agarrar(1)));
            CommandScheduler.getInstance().schedule(new InstantCommand(()-> m_arm.setArmPosition(-675)));
