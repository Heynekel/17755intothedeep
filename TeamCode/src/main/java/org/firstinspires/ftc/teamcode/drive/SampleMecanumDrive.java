...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(12.3, 0, 0.007);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(13, 0, 0.009);
